/**
 * The MorseCodeTree class represents a binary tree used to convert Morse code into English letters.
 * This class implements the LinkedConverterTreeInterface and provides methods to build the tree,
 * add nodes, fetch data, and perform traversals.
 * 
 * @param <String> the type of the data stored in the tree nodes
 * 
 * @see LinkedConverterTreeInterface
 * @see TreeNode
